...
# timedata = datetime.now(pytz.timezone('US/Central'))
# timedata = datetime.now(pytz.timezone('US/Pacific'))
# dt_string = timedata.strftime('%Y/%m/%d %H:%M:%S')
#print("date and time =", dt_string)
# yyyy/mm/dd H:M:S date format
# from datetime import datetime

todaydate = date.today()
#todaytime = datetime.today().time().strftime("%H:%M:%S")
todaytime = datetime.datetime.now().strftime("%H:%M:%S")
print(str(todaydate) + ' ' + str(todaytime))
dt_string = str(todaydate) + ' ' + str(todaytime)
...
def get_trading_close_holidays(year):
  ...
  holidaysus = inst.holidays(dt.datetime(year - 1, 12, 31),
                             dt.datetime(year, 12, 31))
  holidaysus_list = holidaysus.strftime('%Y-%m-%d').tolist()
  holidaysus_dict = holidaysus.to_dict()
  return holidaysus_list, holidaysus, holidaysus_dict


# Define the USTradingCalendar object
inst = USTradingCalendar()

# Get the list of holiday dates for the current year
today = date.today()
year = today.year
holidaysus = inst.holidays(dt.datetime(year - 1, 12, 31),
                           dt.datetime(year, 12, 31))
holidays_us_list = inst.holidays(dt.datetime(
    year - 1, 12, 31), dt.datetime(year, 12,
                                   31)).strftime('%Y-%m-%d').tolist()
print(holidays_us_list)

# Get the list of Saturdays and Sundays for the year
saturdays_and_sundays = []
for month in range(1, 13):
  for day in range(1, 32):
    try:
      date_obj = dt.date(year, month, day)
      if date_obj.strftime('%A') == 'Saturday' or date_obj.strftime(
          '%A') == 'Sunday':
        saturdays_and_sundays.append(date_obj.strftime('%Y-%m-%d'))
    except ValueError:
...
#   return render_template('gainerstable.html',
#                          tables=[data.to_html()],
#                          titles=[''])
...
#   return render_template('loserstable.html',
#                          tables=[data.to_html()],
#                          titles=[''])
...
#   return render_template('mostactivetable.html',
#                          tables=[data.to_html()],
#                          titles=[''])
...
#   return render_template('trendingtable.html',
#                          tables=[data.to_html()],
#                          titles=[''])
...
#   # holidaysvalues = []
#   # try:
#   #   for leavesday in holidays_us_list:
#   #     holidaysvalues.append(leavesday)
#   # except ValueError:
#   #   # Ignore invalid dates (e.g., Feb 30)
#   #   pass
#   # Check if the input date is a US holiday
#   #input_date = input("Enter the date as YYYY-MM-DD: ",)
...
#   # input_date = input()
#   print(input_date)
#   # Check if the input date is a US holiday or a Saturday/Sunday
#   #if input_date in holidays_us_list or saturdays_and_sundays:
#   # holiday_name = holidaysus_dict[input_date]

#   #output = "{} is a US Holiday - It's Holiday".format(input_date)
...
#   # print(str(todaydate) + ' ' + str(todaytime))
#   dt_string = str(todaydate) + ' ' + str(todaytime)
#   # Get the current date in Houston
#   # input_date = datetime.datetime.now(timezone).date()
#   # print(input_date)
#   # input_date = input()
#   # # input_date = input_date.isoformat()
#   # print(input_date)
#   # if input_date in holidays_us_list or saturdays_and_sundays:
#   #   output = "{} is a US Holiday - It's Holiday (or) it's Saturday or Sunday".format(input_date)
#   #   print(output)
#   if input_date in holidays_us_list:
#     # holiday_name = holidaysus_dict[input_date]
#     output = "{} is a US Holiday - It's Holiday".format(input_date)
#     print(output)
#     return '400 Status: not ok' + ' ' + output
#   elif input_date in saturdays_and_sundays:
#     print(saturdays_and_sundays)
#     output = "{} is a US Saturday or Sunday".format(input_date)
#     return '400 Status: not ok' + ' ' + output
#   else:
#     if input_date.weekday() < 5 and datetime.time(
#         5, 0) <= now <= datetime.time(19, 0):
#       if datetime.time(5, 0) <= now <= datetime.time(19, 0):
#         output = "It's a working day between 7 AM and 7 PM in Houston"
...
#         ftp_server.quit()
#         requests.get(
#           "https://stocks.desss-portfolio.com/yahoo/yahoo_gainers"
#         )  #schedule.every(10).minutes.until(timedelta(hours=1)).do(gainersdatas)
#         #time.sleep(650)
...
#         #     break
#         #time.sleep(1)
#         # return '200 Status:ok'+' '+output
#         # return '200 Status: ok' + ' ' + output
#         print(output)
#         return '200 Status:  ok' + ' ' + output
#     else:
#       output = "It will won't work after after 7 AM or 7 PM in a working day"
#       print(output)
#       return '400 Status: not ok' + ' ' + output
#     return '400 Status: not ok'
#     # output = "{} is neither a US Holiday nor a US Saturday/Sunday".format(
#     #   input_date)
#     # url = 'https://finance.yahoo.com/gainers?offset=0&count=100'
#     # #url = request.form['namee']
#     # #gainers = form(name = url)
...
#   today = date.today()
#   year = today.year
#   holidaysus = inst.holidays(datetime.datetime(year - 1, 12, 31),
#                              datetime.datetime(year, 12, 31))
#   holidays_us_list = inst.holidays(datetime.datetime(
#     year - 1, 12, 31), datetime.datetime(year, 12,
#                                          31)).strftime('%Y-%m-%d').tolist()
#   print(holidays_us_list)
#   # holidaysus_dict = a
#   # holidaysvalues = []
...
#         dts = soup.find_all('td', attrs={'aria-label': 'Change'})
...
def nasdaqc():
  ...
  today = date.today()
  year = today.year
  inst.holidays(datetime.datetime(year - 1, 12, 31),
                datetime.datetime(year, 12, 31))
  holidays_us_list = inst.holidays(datetime.datetime(
      year - 1, 12, 31), datetime.datetime(year, 12,
                                           31)).strftime('%Y-%m-%d').tolist()
  ...
  if input_date in holidays_us_list:
    ...
    if input_date.weekday() < 5 and datetime.time(
      ...
      #print(user_agent)
        ...
        previousclose = soup.find_all('td',
                                      attrs={'data-test': 'PREV_CLOSE-value'})
        change = soup.find_all('fin-streamer',
                               attrs={'data-test': 'qsp-price-change'})
        fiftytwo = soup.find_all(
            'td', attrs={'data-test': 'FIFTY_TWO_WK_RANGE-value'})
        ...
        dictionary = {
            'Price': price_,
            'Previousclose': previousclose_,
            'Change': change_,
            'Fiftytwo': fiftytwo_,
            'Day': day_,
            'date/time': dt_string,
        }  #'Fiftytwo': fiftytwo_, }#'Volume': fb_, 'Avg volume': gb_, 'Market cap': hb_, 'Ration': ib_,}
        ...
        ftp_server.quit()
        requests.get(
            "https://stocks.desss-portfolio.com/yahoo/yahoo_global_current")
        #losersfile
        return 'Status 200:ok' + ' ' + output
      else:
        output = "It will won't work after after 7 AM or 7 PM in a working day"
  ...
  if input_date in holidays_us_list:
    ...
    if input_date.weekday() < 5 and datetime.time(
      ...
      if datetime.time(5, 0) <= now <= datetime.time(19, 0):
        ...
        #html = requests.get(url).content
        soup = BeautifulSoup(html, 'lxml')
        nfutureprice = soup.find_all('fin-streamer',
                                     attrs={'data-test': 'qsp-price'})
        changes = soup.find_all('fin-streamer',
                                attrs={'data-test': 'qsp-price-change'})
        lastprice = soup.find_all('td',
                                  attrs={'data-test': 'LAST_PRICE-value'})
        ...
        ftp_server.quit()
        requests.get(
            "https://stocks.desss-portfolio.com/yahoo/yahoo_global_future")
        #losersfile
        return 'Status 200:ok' + ' ' + output
      else:
        output = "It will won't work after after 7 AM or 7 PM in a working day"
...
#                                     fieldnames=table_headers.values(),
#                                     extrasaction='ignore')
#         csv_output.writeheader()

#         for table_row in table['rows']:
#           csv_row = {
#             table_headers.get(key, None): value
...
#       dwarfs.append(i)
#     print(dwarfs)
#     df = pd.DataFrame(index=dwarfs,
#                       columns=[
#                         'symbol', 'regularMarketPrice', 'Change',
#                         'Change Percentage', 'previousClose'
#                       ])
...
#       df.loc[
#         i, 'symbol'] = datas['chart']['result'][0]['meta']['symbol'] or np.nan
#       df.loc[i, 'regularMarketPrice'] = datas['chart']['result'][0]['meta'][
#         'regularMarketPrice'] or np.nan
#       df.loc[i, 'Change'] = round(
#         ((datas['chart']['result'][0]['meta']['regularMarketPrice']) -
#          (datas['chart']['result'][0]['meta']['previousClose'])),
#         2)  #or np.nan
#       df.loc[i, 'Change Percentage'] = round(
#         ((((datas['chart']['result'][0]['meta']['regularMarketPrice']) -
#            (datas['chart']['result'][0]['meta']['previousClose'])) /
#           (datas['chart']['result'][0]['meta']['previousClose'])) * 100),
#         2)  #or np.nan
#       df.loc[i, 'previousClose'] = datas['chart']['result'][0]['meta'][
...
#         #html = requests.get(url).content
#         csv_input = pd.read_csv('stocks2.csv', index_col=[0])
#         csv_input['date/time'] = dt_string
...
#         requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update1")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update2")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update3")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update4")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update5")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update6")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update7")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update8")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update9")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update10")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update11")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update12")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update13")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update14")
#         # requests.get(
#         #   "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update15")
#         #losersfile
#         return 'Status 200:ok' + ' ' + output
#       else:
#         output = "It will won't work after after 7 AM or 7 PM in a working day"
...
#### pHP support API
@app.route("/phpmasterupdate", methods=["GET", "POST"])
def phpmasterupdate():
  #if request.method == "GET":
  #if True:
  inst = USTradingCalendar()
  ...
  if input_date in holidays_us_list:
    ...
    if input_date.weekday() < 5 and datetime.time(
      ...
      if datetime.time(5, 0) <= now <= datetime.time(19, 0):
        output = "It's a working day between 7 AM and 7 PM in Houston"
        requests.get(
            "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update")
        # requests.get(
        #   'https://stocks.desss-portfolio.com/yahoo/yahoo_master_favorite_update'
        # )
        print('ok')
        return '200 Status: ok' + ' ' + output
      else:
...
# #### pHP support API
# @app.route("/phpmasterupdate1", methods=["GET", "POST"])
# def phpmasterupdate1():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
#           "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update1")
#         # requests.get(
#         #   'https://stocks.desss-portfolio.com/yahoo/yahoo_master_favorite_update1'
#         # )
#         print('ok')
#         return '200 Status: ok' + ' ' + output
#       else:
...
# #### pHP support API
# @app.route("/phpmasterupdate2", methods=["GET", "POST"])
# def phpmasterupdate2():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate3", methods=["GET", "POST"])
# def phpmasterupdate3():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate4", methods=["GET", "POST"])
# def phpmasterupdate4():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate5", methods=["GET", "POST"])
# def phpmasterupdate5():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate6", methods=["GET", "POST"])
# def phpmasterupdate6():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate7", methods=["GET", "POST"])
# def phpmasterupdate7():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate8", methods=["GET", "POST"])
# def phpmasterupdate8():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate9", methods=["GET", "POST"])
# def phpmasterupdate9():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate10", methods=["GET", "POST"])
# def phpmasterupdate10():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate11", methods=["GET", "POST"])
# def phpmasterupdate11():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate12", methods=["GET", "POST"])
# def phpmasterupdate12():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate13", methods=["GET", "POST"])
# def phpmasterupdate13():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate14", methods=["GET", "POST"])
# def phpmasterupdate14():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
# #### pHP support API
# @app.route("/phpmasterupdate15", methods=["GET", "POST"])
# def phpmasterupdate15():
#   #if request.method == "GET":
#   #if True:
#   inst = USTradingCalendar()
...
@app.route("/nasdaqcurrentschedule", methods=["GET", "POST"])
def nasdaqcurrentschedule():
  #if request.method == "GET":
  #if True:
  ...
  print('8 minutes once printed')
  return "Welcome Home :) !"


@app.route("/nasdaqfutureschedule", methods=["GET", "POST"])
def nasdaqfutureschedule():
  #if request.method == "GET":
  #if True:
  requests.get("https://ystocks.mobilteam.repl.co/nasdaqfuture")
  #print(time.strftime("%A, %d. %B %Y %I:%M:%S %p"))  #time.strftime convert a time string to tuple
  print('30 minutes once printed')
  return "Welcome Home :) !"
...
@app.route("/phpmasterupdates", methods=["GET", "POST"])
def phpmasterupdates():
  #if request.method == "GET":
  #if True:
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update1")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update2")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update3")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update4")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update5")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update6")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update7")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update8")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_master_update9")
  requests.get(
      "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update10")
  requests.get(
      "https://stocks.desss-portfolio.com/yahoo/yahoo_master_update11")
...
@app.route("/phpemail", methods=["GET", "POST"])
def phpemail():
  #if request.method == "GET":
  #if True:
  requests.get("https://openstorj.com/admin/cron_jobs_mail")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('30 minutes once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/phpchristmaspromoemail", methods=["GET", "POST"])
def phpchristmaspromoemail():
  requests.get("https://texasknife.com/christmas_mail/promo_mail")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('1 hour once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/phpchristmaspromoemail2", methods=["GET", "POST"])
def phpchristmaspromoemail2():
  requests.get("https://texasknife.com/christmas_mail/promo_mail_one")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('1 hour 15 minutes  once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/phpchristmaspromoemail3", methods=["GET", "POST"])
def phpchristmaspromoemail3():
  requests.get("https://texasknife.com/christmas_mail/promo_mail_two")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('1 hour 30 minites  once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/phpemailtest", methods=["GET", "POST"])
def phpemailtest():
  #if request.method == "GET":
  #if True:
  requests.get("https://www.desss.com/")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('thirty minute once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/mgtmasterupdate", methods=["GET", "POST"])
def mgtmasterupdate():
  #most active , gainers, trending
  #if request.method == "GET":
  #if True:
  # every 15 mins
  requests.get("https://stocks.desss-portfolio.com/yahoo/most_active_master")
  requests.get("https://stocks.desss-portfolio.com/yahoo/yahoo_gainers_master")
  requests.get(
      "https://stocks.desss-portfolio.com/yahoo/yahoo_trending_master")

  todaytime = datetime.datetime.now()
  print(todaytime)
  print('15 minute once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


@app.route("/mgtmasterupdateemail", methods=["GET", "POST"])
def mgtmasterupdateemail():
  #most active , gainers, trending
  #if request.method == "GET":
  #if True:
  # every 15 mins
  ...
  if input_date in holidays_us_list:
    ...
    if input_date.weekday() < 5 and datetime.time(
        8, 0) <= now <= datetime.time(16, 0):
      # Check if the current time is between 8:00 AM (08:00) and 4:00 PM (16:00)
      if datetime.time(8, 0) <= now <= datetime.time(16, 0):
        output = "It's a working day between 7 AM and 4 PM in Houston"
        requests.get("https://stocks.desss-portfolio.com/yahoo/email")
        todaytime = datetime.datetime.now()
        print(todaytime)
        print('17 minute once printed')
  # requests.get("https://stocks.desss-portfolio.com/yahoo/email")
  # todaytime = datetime.datetime.now()
  # print(todaytime)
  # print('17 minute once printed')
...
@app.route("/masterupdatetest", methods=["GET", "POST"])
def masterupdatetest():
  #if request.method == "GET":
  #if True:
  requests.get("https://ystocks.mobilteam.repl.co/phpmasterupdate")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('three minute once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"


#master delete 12 hours once


@app.route("/masterdeletetest", methods=["GET", "POST"])
def masterdeletetest():
  #if request.method == "GET":
  #if True:
  requests.get("https://stocks.desss-portfolio.com/yahoo/delete_master_isby")
  todaytime = datetime.datetime.now()
  print(todaytime)
  print('12 hours once printed')
  # print(todaytime.strftime("%A, %d. %B %Y %I:%M:%S %p")
  #     )  #time.strftime convert a time string to tuple
  return "Welcome Home :) !"
...
# scheduler.add_job(func=trending, trigger="interval", minutes=20)
#enable schduler 1 till above code
##non working belwo 2
# scheduler.add_job(func=nasdaq, trigger="interval", minutes=58)
#scheduler.add_job(func=phpemail, trigger="interval", minutes=30)
scheduler.add_job(func=phpemailtest, trigger="interval", minutes=30)
scheduler.add_job(func=masterupdatetest, trigger="interval", minutes=3)
#scheduler.add_job(func=nasdaqc, trigger="interval", minutes=10)
### non working above 2
#enable schduler 2
scheduler.add_job(func=nasdaqcurrentschedule, trigger="interval", minutes=8)
scheduler.add_job(func=nasdaqfutureschedule, trigger="interval", minutes=30)
scheduler.add_job(func=mgtmasterupdateemail, trigger="interval", minutes=17)
scheduler.add_job(func=mgtmasterupdate, trigger="interval", minutes=14)
scheduler.add_job(func=masterdeletetest, trigger="interval", hours=5)
scheduler.add_job(func=phpchristmaspromoemail, trigger="interval", hours=1)
scheduler.add_job(func=phpchristmaspromoemail2,
                  trigger="interval",
                  hours=1,
                  minutes=15)
scheduler.add_job(func=phpchristmaspromoemail3,
                  trigger="interval",
                  hours=1,
                  minutes=30)
...
#enable schduler 2 till above code
# app.run(host='0.0.0.0', port=8080)
