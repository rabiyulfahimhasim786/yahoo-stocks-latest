...
def gainersdatas():
    ...
    #dataframe.to_csv('demo.csv')        # saving the dataframe
    dataframe.to_csv('yahoo_gainers1.csv')
...
def losersdatasfile():
    ...
    #dataframe.to_csv('demo.csv')
            ...
            # saving the dataframe
    dataframe.to_csv('yahoo_losers1.csv')
            # Fill Required Information
    HOSTNAME = "HOSTNAME"
    USERNAME = "username"
    PASSWORD = "password"
    ...
    ftp_server.quit()
    requests.get(
                "https://stocks.desss-portfolio.com/yahoo/yahoo_losers")
    #losersfile
    return 'ok'
...
def mostactivefile():
    ...
    #dataframe.to_csv('demo.csv')
    # saving the dataframe
    dataframe.to_csv('yahoo_most_active1.csv')
    # Fill Required Information
    HOSTNAME = "HOSTNAME"
    USERNAME = "username"
    PASSWORD = "password"
...
def trendingfile():
    ...
    #dataframe.to_csv('demo.csv')
            # saving the dataframe
    dataframe.to_csv('yahoo_trending1.csv')
    # Fill Required Information
    HOSTNAME = "HOSTNAME"
    USERNAME = "username"
    PASSWORD = "password"
    ...
    ftp_server.quit()
    requests.get(
            "https://stocks.desss-portfolio.com/yahoo/yahoo_trending")
        #losersfile
    return 'ok'
...
def nasdaqfile():
    ...
    if request.method == "GET":
        ...
        #html = requests.get(url).content
            ...
            #requests.get("https://stocks.desss-portfolio.com/yahoo/most_active")
            requests.get(
                "https://stocks.desss-portfolio.com/yahoo/yahoo_master")
        #losersfile
        return 'ok'
...
def ystocks301():
    if (request.method == 'GET'):
        ...
        for i in range(0, len(tikcer)):
            ...
            df.loc[i, 'symbol'] = datas['chart']['result'][0]['meta'][
                'symbol'] or np.nan
            df.loc[i, 'regularMarketPrice'] = datas['chart']['result'][0][
                'meta']['regularMarketPrice'] or np.nan
